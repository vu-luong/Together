...
public class Constants {
	...
	public static final String AUDIO_ENDPOINT = "http://10.0.239.115/hackac"
			+ "ademy/Together/Server/recording.php";
	public static final String MSG_LACK_PEOPLE = "Not en fu ki nough";;
