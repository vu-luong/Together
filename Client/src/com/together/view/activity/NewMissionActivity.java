...
public class NewMissionActivity extends LifecycleLoggingActivity {
	...
	private ImageButton mVocabularyButton;
	private ImageButton mGrammarButton;
...
//				mCompleteFragment = new HomeCompleteFragment();
	...
	private void initializeView() {
		mPronounceButton = (ImageButton) findViewById(R.id.pronounceButton);
		mVocabularyButton = (ImageButton) findViewById(R.id.vocabularyButton);
		mGrammarButton = (ImageButton) findViewById(R.id.grammarButton);
