...
public class MainActivity extends LifecycleLoggingActivity implements
	...
	private RelativeLayout mMissionButton;
	private RelativeLayout mBrowseButton;
	...
	private void initializeView() {
		...
		mMissionButton = (RelativeLayout) findViewById(R.id.my_mission);
		mBrowseButton = (RelativeLayout) findViewById(R.id.browse_mission);
	}
	
	public void onMissionTabClick(View v) {
	...
	public void onBrowseTabClick(View v) {
		switchToBrowseFragment();
		((BrowseFragment) mBrowseFragment).getMissions();
