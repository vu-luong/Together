...
public class ExecuteFragment extends
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		mExecutingAdapter = new GenericAdapter<Mission>(
				getApplicationContext(), new MissionViewGenerator());
		...
		super.onViewCreated(view, savedInstanceState, ExecutePresenter.class,
				this);
